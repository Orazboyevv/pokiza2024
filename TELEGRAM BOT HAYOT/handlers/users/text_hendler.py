...
async def bot_info(message: types.Message):
    ...
    text += "Bu esa " + hlink('GitHub uchun link\n', 'https://github.com/isroilovrustam')
...
async def bot_info(message: types.Message):
    ...
    text += "Bu esa <a href='https://github.com/isroilovrustam'>GitHub uchun link</a>.\n"
...
async def bot_info(message: types.Message):
    ...
    text += "Bu esa [GitHub uchun link](https://github.com/isroilovrustam)\n"
